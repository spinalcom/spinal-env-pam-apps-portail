...
export async function getHeatCal(space, tempo, currentTimestamp, source, raw = {start: null, end: null, data: []}, makeCall = true, dayFilter = [false, false, false, false, false, false, false]) {
  try {
  var calendar = [];
  var calendarObject = {};
  ...
  let cpList, cpID = source.dynamicId, timeSeries, prevTimeSeries, prevSumSeries, sumSeries, prevTotRoot, prevAvgRoot;
    ...
    if (makeCall) {
      try {
        ...
        if (timeSeries.status === 400) {
          
          let res = {
            "rawData": [],
            "rawInterval": [],
            "y": "2022",
            "n": "Taux d'occupation Bâtiment",
            "d": [
                [
                    -1,
                    -1,
    ...
    timeSeries = timeSeries.filter(({ date }) => {
      ...
      return !dayFilter[isoDayOfWeek - 1];
    });
  ...
  let res = {
    "rawData": [
        {
            "date": 1693096361399,
            "value": 21.503661739043377
        },
        {
            "date": 1693099955640,
            "value": 32.862438148036276
        },
        {
            "date": 1693103555617,
            "value": 27.076919975600674
        },
        {
            "date": 1693107155605,
            "value": 23.31269400505059
        },
        {
            "date": 1693110755641,
            "value": 18.25962242212552
        },
        {
            "date": 1693114355620,
            "value": 31.312018849539108
        },
        {
            "date": 1693117955604,
            "value": 24.68529458192893
        },
        {
            "date": 1693121555632,
            "value": 23.7223867869279
        },
        {
            "date": 1693125155609,
            "value": 19.5955210230627
        },
        {
            "date": 1693178860002,
            "value": 21.503661739043377
