    ...
    <v-card elevation="4" class="cardContainer">
      ...
      <div class="graphDataContainer" v-show="ActiveData || !DActive">
        ...
        <div v-if="!isFullGraph" class="dataContainer" :style="{ width: ActiveData ? '40%' : '100%' }"
            ...
            <div class="calcul_content">
              <div class="calcul">
                ...
                <div class="calculResult">
                  ...
                  <div class="text" v-if="!loadbuilding">Pour l'étage {{ selectedZone.name }}</div>
                  <div class="text" v-if="loadbuilding">Pour le batiment {{ selectedZone.name }}</div>
          ...
          <div class="detail_container" v-else-if="pageSate === PAGE_STATES.loaded && isBuildingSelected">
    ...
    const config_copy = {
     ...
     await this.regroupItemsAndCalculate(true);
      ...
      this.total = calculateTotal(
        this.data.map((el) => el.displayValue),
        this.calculMode
      );
