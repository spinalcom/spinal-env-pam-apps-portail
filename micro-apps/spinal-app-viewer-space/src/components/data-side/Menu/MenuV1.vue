      ...
      <div v-if="menuVisible" class="subs">
        <div
          ...
          :class="[
            'sub-circle',
            `position-${index + 1}`,
            { selected: item.toggeable && selectedItems.includes(item.value) },
          ]"
...
export default {
  ...
  data() {
    return {
      isChecked: false,
      menuVisible: false,
      selectedItems: [3] as number[],
      subItems: [
        {
          value: 1,
          icon: 'mdi-format-list-bulleted-type',
          title: 'Sélection catégorie/groupe',
          toggeable: false,
        },
        {
          value: 2,
          icon: 'mdi-radar',
          title: 'Mode Radar/Tableau',
          toggeable: true,
        },
        
        {
          ...
          title: "Filtrer sur l'étage sélectionné",
          toggeable: true,
        },
        {
          value: 4,
          icon: 'mdi-math-log',
          title: 'Surface normal/logarithmique',
          toggeable: true,
        },
        {
          value: 5,
          icon: 'mdi-format-list-bulleted',
          title: 'Filtre nomenclature',
          toggeable: false,
        },
      ],
    };
