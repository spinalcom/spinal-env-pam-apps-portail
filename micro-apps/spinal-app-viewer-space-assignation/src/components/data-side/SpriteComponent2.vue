    ...
    <div v-if="isopen" ref="container" class="container">
      ...
      <div class="card">
        <div class="top-section">
          ...
          <div class="icons">
            <div class="logo">
              {{ data.selectedRoom.title || data.selectedRoom.name}}
            </div>
            <div class="social-media">
              {{ data.selectedRoom.area.toFixed(2) }} m²
            </div>
          </div>
              ...
              <div style="display: flex; margin-top: 10px">
                ...
                >
                  ...
                  <div
                    ...
                    "
                  >
                    {{ data.selectedRoom.grandParentTitle }}</div
                  >
                </div>
                <div
                  style="
...
export default {
  ...
  mounted() {
    ...
    this.viewerEventHandler = emitterHandler;
    //console.log('data received in sprite : ', this.data);
  ...
  methods: {
    ...
    unassignEvent() {
      this.viewerEventHandler.emit('groupAssignment:unassign', this.data.selectedRoom)
    },
    assignEvent(){
      this.viewerEventHandler.emit('groupAssignment:assign', this.data.selectedRoom)
    },
    changeRoute(route) {
