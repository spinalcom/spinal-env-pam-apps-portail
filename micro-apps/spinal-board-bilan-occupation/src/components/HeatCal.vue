<template>
    ...
    <v-card-title class="card-title flex-shrink-1 justify-space-between">
        ...
        <div class="d-flex align-center mln6" style="position: absolute; right: calc(50% - 50px); font-size: 0.875em;" v-if="true">
            <v-icon style="margin-top: -1px; font-size: 1.125em; margin-right: 10px; color: #63717f;">{{ env.unit.left.icon }}</v-icon>
            ...
            <v-icon style="margin-top: -1px; font-size: 1.125em; margin-left: -10px; color: #63717f;">{{ env.unit.right.icon }}</v-icon>
        </div>
        <div v-if="true" style="height: 40px; align-self: flex-start; padding-top: 10px; padding-right: 10px;">
            <v-btn :disabled="false" @click="$emit('nav', -1)" style="font-size: 0.875em !important; border-radius: 10px;  min-width: 36px !important; box-shadow: none; border: 1px solid #EAEEF0 !important;"><v-icon style="color: #14202c !important" icon>mdi-chevron-left</v-icon>{{ prev }}</v-btn>
            <v-btn :disabled="false" @click="$emit('nav', +1)" style="font-size: 0.875em !important; border-radius: 10px;  min-width: 36px !important; box-shadow: none; border: 1px solid #EAEEF0 !important;">{{ next }}<v-icon style="color: #14202c !important" icon>mdi-chevron-right</v-icon></v-btn>
        </div>
    </v-card-title>
    <div class="d-flex flex-column" style="width: 100%; height: 100%">
        <div class="selects">
            <v-select v-model="space" append-icon="mdi-chevron-down" :items="source" outlined menu-props="{ bottom: true }" color="#000000DE" item-color="#000000DE" dense style="margin-left: 10px !important; min-width: 100px; width: 300px; flex-grow: 0; font-size: 0.875em !important;" class="ml-8" :label="selectTitle">
            ...
            <v-select v-model="calculation" append-icon="mdi-chevron-down" :items="calculationList" outlined menu-props="{ bottom: true }" color="#000000DE" item-color="#000000DE" dense style="margin-left: 10px !important; min-width: 100px; width: 130px; flex-grow: 0; font-size: 0.875em !important;" class="ml-8" label="Calcul">
                <!-- <template #label="{ attrs }"> <label :for="attrs.id" style="font-size: 14px;">Select an item</label></template> -->
            ...
            <div class="selects inside">
                <v-select v-model="timeRange" append-icon="mdi-chevron-down" :items="timeRanges" outlined menu-props="{ bottom: true }" color="#000000DE" item-color="#000000DE" dense style="margin-left: 10px !important; min-width: 200px; width: 200px; flex-grow: 0; font-size: 0.875em !important;" class="ml-8" label="Intervalle de temps">
                    <!-- <template #label="{ attrs }"> <label :for="attrs.id" style="font-size: 14px;">Select an item</label></template> -->
        ...
        <div class="flex-grow-1 content-main" v-if="chart === 'calendar'">
            ...
            <div class="d-flex flex-row" style="padding: 10px; width: 100%; height: 75%; justify-content: space-between; gap: 10px; " v-else-if="chart === 'line'">
                <CalendarAndStripe v-if="data && data.d && data.d.length>0"
                    style="width: 30%"
                    :calMonths="calMonths"
                    @dayFilter="dayFilter" 
...
.content-main {
    width: 100%; height: 75%; overflow: hidden; overflow-x: auto;
}
