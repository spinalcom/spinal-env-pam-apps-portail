<template>
  ...
  <template v-slot:[`item.naming`]="{ item }">
    <SmallLegend class="ml-3" :size="11" :color="positiveColor(item.availability, 70)" :text="(typeof item.naming!=='undefined')? parseInt(item.naming.toFixed(0)) +'%': 'indéfini' " />
  </template>
  <template v-slot:[`item.default`]="{ item }">
    <SmallLegend class="ml-3" :size="11" :color="negativeColor(item.availability, 30)" :text="(typeof item.naming!=='undefined')? parseInt(item.default.toFixed(0)) +'%': 'indéfini'"/>
  </template>
  <template v-slot:[`item.availability`]="{ item }">
    <SmallLegend class="ml-3" :size="11" :color="positiveColor(item.availability, 70)" :text="(typeof item.naming!=='undefined')? parseInt(item.availability.toFixed(0)) +'%': 'indéfini'"/>
  </template>
</v-data-table>
  </div>
</template>
...
export default {
  ...
  data: () => ({
    headers: [
      ...
      { text: 'Convention de nommage', value: 'naming' },
