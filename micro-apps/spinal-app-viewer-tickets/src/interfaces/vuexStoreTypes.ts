...
export enum ActionTypes {
  ...
  NEXT_STEP_TICKET = "NEXT_STEP_TICKET",
  PREVIOUS_STEP_TICKET = "PREVIOUS_STEP_TICKET",
  MOVE_TO_STEP_TICKET = "MOVE_TO_STEP_TICKET",
  RESET_API_ITERATOR_STORE = "RESET_API_ITERATOR_STORE",
  GET_BUILDING_REFERENCE_OBJECTS = "GET_BUILDING_REFERENCE_OBJECTS",
  ADD_NOTE = "ADD_NOTE",
