...
export const actions: ActionTree<StateAppData, StateAppData> & Actions = {
  ...
  async [ActionTypes.OPEN_VIEWER]({ commit, dispatch, state }: AugmentedActionContextAppData, playload: { onlyThisModel: boolean;  item: ISpaceSelectorItem} ): Promise<void> {
  ...
  [ActionTypes.UNLOAD_MODEL]: FctViewerIteract.bind(null, VIEWER_EVENTS.UNLOAD),
};
