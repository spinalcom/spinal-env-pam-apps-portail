...
export class ViewerManager {
	...
	// public async addLines(source: IPlayload | IPlayload[],destinations: IPlayload | IPlayload[], buildingId?: string) {
	// 	const formatted = await this._getAndFormatViewerInfos(source,destinations ,buildingId);
	// 	const emitter = EmitterViewerHandler.getInstance();
	// 	emitter.emit(VIEWER_ADD_SPRITE, formatted as any);
	// }
