    ...
    <div class="flip-card">
      <div class="flip-card-inner" :class="{ flipped: showDetailsProp }">
        ...
        <div class="flip-card-front">
          ...
          <div class="desc-container-wrapper">
            <div class="desc-container-typologie">
              <div v-for="(count, typologie) in typologieCounts" :key="typologie" class="typologie-item">
                <div class="typo-img" :style="{ backgroundImage: `url(${getImageUrl(typologie)})` }"></div>
        ...
        <div class="flip-card-back" v-if="showDetailsProp">
          <div class="title-container">
            <p class="stat-title">Total Overview</p>
          </div>
          <div class="echeletotal">
