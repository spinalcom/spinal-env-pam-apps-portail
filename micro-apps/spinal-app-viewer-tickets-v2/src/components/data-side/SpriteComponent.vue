<template>
  <div v-if="data.data[0].elementSelected.type == 'BIMObject'" class="sprite_container_triangle pa-1" :style="{
  ...
  <div v-else class="sprite_container pa-1" :style="{
    ...
    <div class="sprite_color d-flex align-center justify-center" :style="{
      background: '#14202C',
      color: '#FFFFFF',
      'text-align': 'center',
      ...dynamicStyle,
...
export default {
  ...
  methods: {
    onClick() {
      ...
      console.log("Move to top", this.data.data);
