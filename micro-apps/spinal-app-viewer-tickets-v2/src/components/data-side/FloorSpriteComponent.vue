<template>
  <div id="floor-sprite" class="sprite_container pa-1" :style="{
    ...
    <div class="sprite_color d-flex flex-grow-1 align-center justify-center" :style="{
      background: '#14202C',
      color: '#FFFFFF',
      'text-align': 'center',
      ...dynamicStyle,
...
export default {
  ...
  mounted() {
    // console.log("laaaaaaaaaaaaaaaaaaalalaaaa", this.data.data);
  },
  methods: {
    onClick() {
