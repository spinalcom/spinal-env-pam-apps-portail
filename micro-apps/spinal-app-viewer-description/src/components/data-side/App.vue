...
<template>
  ...
  <div class="appli">
    ...
    <div style="max-height: 100%; display:flex; overflow: hidden ; overflow-y: auto; flex-direction: column; align-content:space-between;" :class="{'doc-content': showDocvalue , 'w-full': !showDocvalue}">
