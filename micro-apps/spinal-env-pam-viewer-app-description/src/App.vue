...
class App extends Vue {
  ...
  async mounted() {
    ...
    this.$nextTick(() => {
      ...
      this.query.app = ""
      // console.warn('/////////////////////////////////////////////////////');
