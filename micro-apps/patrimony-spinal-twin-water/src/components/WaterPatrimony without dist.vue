<template>
  <div class="RC" style="min-height: 480px">
    <div class="MC">
      <LineCard v-if="loaded" :title="'CONSOMMATION D\'EAU'" :labels="barLabels" :datasets="barChartData" :optional="lineOptions" class="BR"/>
      <div class="d-flex cards">
        <sc-stat-card
          :value="6498"
          :title="'m² Superficie totale (3 Bâtiments)'"
          class="flex-grow-1 pa-4"
          />
          <sc-stat-card
          :value="8080009"
          :title="'L consommé par le patrimoine'"
          class="flex-grow-1 pa-4"
          />
          <sc-stat-card
          :value="80800"
