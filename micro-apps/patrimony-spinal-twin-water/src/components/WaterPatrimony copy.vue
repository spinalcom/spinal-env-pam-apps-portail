<template>
  <div class="RC" style="min-height: 480px">
    <div class="MC">
      <sc-bar-card v-if="loaded" :title="'CONSOMMATION D\'EAU'" :labels="barLabels" :datasets="barChartData" class="BR"></sc-bar-card>
