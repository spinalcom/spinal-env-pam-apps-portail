  ...
  <div class="RC" style="min-height: 480px">
    <div class="MC" v-if="loaded">
      ...
      <div class="d-flex cards">
        ...
        <sc-stat-card :value="stats.totalConsumptionSquareMeter" :unit="'L'"  :title="'consommé au m²'" class="flex-grow-1 pa-4"/>
      </div>
...
export default {
  ...
  methods: {
    ...
    async onRequest() {
      let res;
      this.loaded = false;
      res= await getData(this.currentTimestamp.valueTime, this.temporality.name, this.buildingsInTheList, 'Eau globale');
